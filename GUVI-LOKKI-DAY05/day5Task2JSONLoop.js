  ...
  //DAY5
  //TASK 02 - for the above  JSON, iterate over all for loops(for, for in, for of, for each).
...
let resume1 = [{
  ...
  for(var i = 0; i<resume1.length; i++){
    console.log(resume1[i]);
  }


  //2nd LOOP - for in Loop
 ...
 console.log("Using for...in loop:");
  for(var one in resume2){
    console.log(i,resume2[one]);
}


//3rd LOOP - for of Loop

console.log("Using for...of loop:");
for(var two of resume1){
    console.log(two);
  }

 
//4th LOOP - for each Loop

console.log("Using for...each loop:");
resume1.forEach(three => {
    console.log(three)
  });
